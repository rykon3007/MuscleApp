...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF333A40);
  late Color secondary = const Color(0xFFDDE0E4);
  late Color tertiary = const Color(0x75767975);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF333A40);
  late Color secondaryText = const Color(0xFF9D9FA5);
  late Color primaryBackground = const Color(0xFFE4E4E6);
  late Color secondaryBackground = const Color(0xFFF0F0F2);
...
class ThemeTypography extends Typography {
  ...
  String get labelMediumFamily => 'Bebas Neue';
  ...
  String get bodySmallFamily => 'Bebas Neue';
